...
{
    internal class CocktailReceivedEventHandler : IIntegrationEventHandler<CocktailReceivedIntegrationEvent>
    {

        private readonly ICocktailRepository _cocktailRepository;
        private readonly ILogger<CocktailReceivedEventHandler> _logger;

        public CocktailReceivedEventHandler(ICocktailRepository cocktailRepository, ILogger<CocktailReceivedEventHandler> logger)
        {
        ...
        public Task Handle(CocktailReceivedIntegrationEvent @event)
        {
            ...
            return Task.Run(async () =>
            {
                ...
                await _cocktailRepository.CreateCocktailAsync(cocktail);
