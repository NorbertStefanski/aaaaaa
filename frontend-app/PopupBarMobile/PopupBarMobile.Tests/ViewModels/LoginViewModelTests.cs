...
namespace PopupBarMobile.Tests.ViewModels
{
    public class LoginViewModelTests
    {
        ...
        public void BeforeEachTest()
        {
            ...
            _model = new LoginViewModel(_identityServiceMock.Object, _tokenProviderMock.Object, _navigationServiceMock.Object);
        }
        ...
        public void LoginCommand_SuccessfulLogin_ShouldSaveAccessTokenAndNavigateToTeamsPage()
        {
            ...
            _navigationServiceMock.Verify(service => service.NavigateAsync("SettingsView"), Times.Once);
        }
